...
if __name__ == "__main__":
    ...
    f1 = math.sin
    x0=math.pi
    print("Métodos para hallar derivadas:")
    dx0 = Derivada(f1,metodo="adelante",dx=0.001)
    print("Método: ",dx0.met,"= ",dx0.calc(x0))
    dx1 = Derivada(f1,metodo="central",dx=0.001)
    print("Método: ",dx1.met,"= ",dx1.calc(x0))
    dx2 = Derivada(f1,metodo="extrapolada",dx=0.001)
    print("Método: ",dx2.met,"= ",dx2.calc(x0))
    dx3 = Derivada(f1,metodo="segunda",dx=0.001)
    print("Método: ",dx3.met,"= ",dx3.calc(x0))
    print("Métodos para hallar raices:")
    x2 = []
    y2 = []
    j = 0
    error = 1e-10
